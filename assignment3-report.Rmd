...
*Note: All R squared values and p-values exist in inline code. Please run code to see values and descriptions of values.*  
...
ggplot(spending_melt) +
  ...
  ggtitle("Figure X - GDP versus Spending") +
  xlab("Year") +
  ylab("Dollars (USD)")
```
...
ggplot(roc_melt) +
  ...
  scale_color_manual(values = c("red","green", "blue"),
                     labels = c("GDP", "Total Spending", "Discretionary Spending")) +
  ggtitle("Figure X - Rate of Change: GDP, Total Spendng, Discretionary Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(fed_melt) +
  ...
  ggtitle("Figure X - Rate of Change: GDP versus Federal Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(energy_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: GDP versus Energy Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(climate_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: GDP versus Climate Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(fed_roc_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: GDP and Federal Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(energy_roc_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: GDP and Energy Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(climate_roc_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: GDP and Climate Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(fed_melt_total_spend) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: Total Spending versus Federal Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(energy_melt_total_spend) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: Total Spending versus Energy Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(climate_melt_total_spend) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: Total Spending versus Climate Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(fed_roc_total_spend_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: Total and Federal Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(energy_roc_total_spend_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: Total and Energy Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(climate_roc_total_spend_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: Total and Climate Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(fed_melt_disc_spend) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: Discretionary Spending versus Federal Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(energy_melt_disc_spend) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: Discretionary Spending versus Energy Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(climate_melt_disc_spend) +
  geom_line(aes(x = year, y = value, color=variable)) +
  scale_color_manual(values = c("red", "blue")) +
  ggtitle("Figure X - Rate of Change: Discretionary Spending versus Climate Spending") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(fed_roc_disc_spend_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: Discretionary and Federal Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(energy_roc_disc_spend_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: Discretionary and Energy Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```
...
ggplot(climate_roc_disc_spend_melt) +
  geom_line(aes(x = year, y = value, color=variable)) +
  ggtitle("Figure X - Rate of Change: Discretionary and Climate Spending per Department") +
  xlab("Year") +
  ylab("Percent Change (%)")
```